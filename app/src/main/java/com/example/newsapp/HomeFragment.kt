...
class HomeFragment : Fragment() , NewsItemClicked{
    ...
    override fun onCreateView(
        ...
        val refresh_layout = view.findViewById(R.id.refresh_layout_home) as SwipeRefreshLayout
    ...
    private fun fetchData() {
        val url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=0c819f497dd44d089a24d316bde4e8a4"
